...
<body>
    <div class="brand">Tienda de Abarrotes</div>
    <!-- navegador -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <?php if ($Username == null) {
                        echo '<li><a href="vistas/login.php?rol=usuario">Ingresar</a></li>';
                    } else {
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <center>
                            ...
                            <strong class="product-price">S/.<?php if ($Rows[7] == null) {
                                                                    $precio = $Rows[3];
                                                                    echo $Rows[3];
                                                                } else {
                                                                    $precio = $Rows[7];
                            ...
                            <del class="product-old-price"><?php if ($Rows[5] == null) {
                                                                echo "   ";
                                                            } else {
                                                                $precio = $Rows[3];
                                                                echo "S/." . $Rows[3];
                ...
                <div class="col-lg-12 text-center">
                    <p>
                        ...
                        <strong>
                            ...
                            <?php if ($Username == null) {
                                echo '<a href="vistas/login.php?rol=usuario">Ingresar</a>';
                            } else {
